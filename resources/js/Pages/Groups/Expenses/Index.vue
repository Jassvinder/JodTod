                ...
                <div class="flex gap-3 overflow-x-auto pb-2 -mx-1 px-1">
                    ...
                    >
                        ...
                        <p
                            ...
                            :class="balance.amount >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'"
                        >
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
                    ...
                    <div class="flex gap-2">
                        <input
                            v-model="dateTo"
                            type="date"
                            class="flex-1 py-2.5 px-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                            placeholder="To"
                        />
                        <button
