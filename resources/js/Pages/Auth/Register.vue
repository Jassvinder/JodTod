...
<template>
    <GuestLayout>
        ...
        <h2 class="text-xl font-semibold text-gray-900 mb-6">Account banayein</h2>
        ...
        <form @submit.prevent="submit">
            ...
            <p class="mt-4 text-center text-sm text-gray-600">
                Already registered?
                <Link :href="route('login')" class="text-primary-600 font-medium hover:text-primary-700">Login karein</Link>
            </p>
        </form>
    </GuestLayout>
</template>
